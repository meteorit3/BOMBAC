...
[_base] = LAYOUT(
        ...
        KC_NO,KC_Z,KC_X,KC_C,KC_V,KC_B,                KC_N,KC_M,KC_COMM,KC_DOT,KC_SLASH,KC_NO,       
          MO(_fuck),KC_LSFT,KC_SPC,KC_LCTL,                KC_LALT,KC_BSPC,KC_LGUI,KC_CAPS
),
[_fuck] = LAYOUT(
        KC_ESC,_______,_______,_______,_______,_______,                _______,_______,_______,_______,_______,_______,
        QK_BOOT,_______,_______,_______,_______,_______,                _______,_______,_______,KC_LBRC,KC_RBRC,KC_BSLS,
